...
export function FavoriteButton({ beerId }) {
  ...
  return (
    <button
      className={`${isFavorite(beerId) ? favoriteClass : nonFavoriteClass} rounded-full p-1 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2`}
      type="button"
      onClick={() => toggleFavorite(beerId)}
    >

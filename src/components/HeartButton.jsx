...
export function HeartButton({ checked, onChange }) {
  return (
    <label>
      ...
      <IconOutLine className="peer-checked:hidden  text-gray-400 hover:text-gray-500" aria-hidden="true" />
      <IconSolid className="hidden peer-checked:block   text-red-400 hover:text-red-500" aria-hidden="true" />
    </label>
  );
}
